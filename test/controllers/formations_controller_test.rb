...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference("Formation.count") do
      post formations_url, params: { formation: { debut: @formation.debut, diplome: @formation.diplome, ecole: @formation.ecole, fin: @formation.fin, lieu: @formation.lieu, user_id: @formation.user_id } }
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { debut: @formation.debut, diplome: @formation.diplome, ecole: @formation.ecole, fin: @formation.fin, lieu: @formation.lieu, user_id: @formation.user_id } }
